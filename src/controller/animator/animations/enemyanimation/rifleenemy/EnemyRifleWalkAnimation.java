 ...
 * @author Greg
 */
public class EnemyRifleWalkAnimation extends Animation{
    ...
    public EnemyRifleWalkAnimation() {
        start = new AnimationImage(ImageUtilities.ENEMY_RIFLE, displayTime);
        walking1 = new AnimationImage(ImageUtilities.ENEMY_RIFLE_WALK_1, displayTime);
        walking2 = new AnimationImage(ImageUtilities.ENEMY_RIFLE, displayTime);
        walking3 = new AnimationImage(ImageUtilities.ENEMY_RIFLE_WALK_2, displayTime);
