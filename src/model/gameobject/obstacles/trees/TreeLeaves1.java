 ...
 * @author Greg
 */
public class TreeLeaves1 extends GameObject implements Collideable {

    public TreeLeaves1(float x, float y) {
        super(x, y);
        setImage(ImageUtilities.TREE_LEAVES_1);
        this.isFriend = false;
        this.drawLayer = 3;
    }

    public TreeLeaves1(float x, float y, float rotation) {
        super(x, y);
        setImage(ImageUtilities.TREE_LEAVES_1);
        this.isFriend = false;
        this.drawLayer = 3;
